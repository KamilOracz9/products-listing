    ...
    <Swiper :navigation="sliderConfig.navigation" :pagination="sliderConfig.pagination"
        ...
        <SwiperSlide v-for="(slide, index) in data" :key="index">
            <NuxtLink :to="slide.path" class="relative"
                ...
                <div class="h-[582px] flex relative after:w-full after:h-full after:absolute after:bg-[linear-gradient(90deg,_rgba(29,29,27,0.4)_0%,_rgba(29,29,27,0)_40%,_rgba(29,29,27,0)_100%)] sm:h-[401px] lg:h-[612px] 2xl:h-[716px]">
                ...
                <div class="absolute bottom-4 left-4 text-white md:bottom-1 lg:bottom-32 lg:left-20">
                    ...
                    <h2 v-if="slide.title" class="text-[2.5rem] font-medium leading-[3rem] uppercase xl:text-[50px] xl:leading-[60px]">{{ slide.title }}
                    </h2>
                </div>
            </NuxtLink>
        </SwiperSlide>
