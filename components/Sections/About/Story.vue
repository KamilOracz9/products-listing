    ...
    <section :id="slugify($t('companys-history'))">
        ...
        <div class="flex flex-col gap-6 pt-10 sm:gap-0 xl:flex-row xl:gap-10">
            <div class="section-text mt-0 xl:w-[50%]">
                <p data-aos="fade-up" v-html="story?.body"></p>
                <ul class="pt-10">
                    <li v-for="(item, index) in story?.list" :key="index" class="flex [&:last-child>div]:border-l-0" data-aos="fade-up" :data-aos-delay="index * 100">
            ...
            <div class="xl:w-[50%]">
                <div
                    ...
                    <picture v-for="(image, index) in story.images" :key="index" data-aos="fade-up">
