    ...
    <MenuItemLayout :open="open" :toggleOpen="toggleOpen">
        ...
        <template v-slot:body>
            <div class="flex flex-col p-4 gap-4">
                ...
                <button class="bg-[#bf5fff] text-white h-10 rounded-md" type="button" @click="handleToggleGlobalStore">Przełącz grupowanie</button>
                <button class="bg-[#f3b94d] text-white h-10 rounded-md" type="button" @click="toggleDataShow">Przełącz szczegóły</button>
            </div>
        </template>
    </MenuItemLayout>
</template>
