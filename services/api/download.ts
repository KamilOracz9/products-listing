...
export const fetchDownloadDocumentsPage = async (locale: string): Promise<DownloadPage> => (await $fetch(`${useAppConfig().public.apiBase}/newtrendy/v3/${locale}/cms/download/declarations`));
